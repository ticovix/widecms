...
CKEDITOR.plugins.add( 'widgetbootstrap', {
    ...
    icons: 'widgetbootstrapLeftCol,widgetbootstrapBottomCol,gallery,widgetbootstrapRightCol,widgetbootstrapTwoCol,widgetbootstrapThreeCol,widgetbootstrapAlert',
    ...
    init: function( editor ) {
        ...
        editor.widgets.add( 'widgetbootstrapLeftCol', {
            ...
            button: showButtons ? 'Adicionar coluna com imagem na esquerda' : undefined,

            template:
                '<div class="row two-col-left">' +
                    '<div class="col-md-3 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail"/></p></div>' +
        ...
        editor.widgets.add( 'widgetbootstrapBottomCol', {

            button: showButtons ? 'Adicionar coluna com imagem no topo' : undefined,

            template:
                '<div class="row two-col-bottom">' +
                    '<div class="col-md-12 col-1"><img src="http://placehold.it/300x100&text=Image" class="img-responsive thumbnail" width="100%"/>' +
                    '<h2>Título</h2><p>A certificação de metodologias que nos auxiliam a lidar com a necessidade de renovação processual representa uma abertura para a melhoria dos métodos utilizados na avaliação de resultados. Por conseguinte, a adoção de políticas descentralizadoras afeta positivamente a correta previsão de todos os recursos funcionais envolvidos.</p></div>' +
                '</div>',
            ...
            upcast: function( element ) {
                return element.name == 'div' && element.hasClass( 'two-col-bottom' );
            }

        } );
        editor.widgets.add( 'gallery', {

            button: showButtons ? 'Adicionar galeria de imagens em grid' : undefined,

            template:
                '<div><div class="row">' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail" width="100%"/></p></div>' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail" width="100%"/></p></div>' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail" width="100%"/></p></div>' +
                '</div>'+
                '<div class="row">' +
        ...
        editor.widgets.add( 'widgetbootstrapRightCol', {
            ...
            button: showButtons ? 'Adicionar coluna com imagem na direita' : undefined,

            template:
                '<div class="row two-col-right">' +
                    '<div class="col-md-9 col-main"><p>Content</p></div>' +
                    '<div class="col-md-3 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail" width="100%"/></p></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapTwoCol', {
            ...
            button: showButtons ? 'Adicionar 2 colunas' : undefined,

            template:
                '<div class="row two-col">' +
                    '<div class="col-md-6 col-1"><p><img src="http://placehold.it/500x280&text=Image" class="img-responsive thumbnail" width="100%"/></p><p>Content</p></div>' +
                    '<div class="col-md-6 col-2"><p><img src="http://placehold.it/500x280&text=Image" class="img-responsive thumbnail" width="100%"/></p><p>Content</p></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapThreeCol', {
            ...
            button: showButtons ? 'Adicionar 3 colunas' : undefined,

            template:
                '<div class="row three-col">' +
                    '<div class="col-md-4 col-1"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive" width="100%"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                    '<div class="col-md-4 col-2"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive" width="100%"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                    '<div class="col-md-4 col-3"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive" width="100%"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapAlert', {
            button: showButtons ? 'Adicionar alert' : undefined,
            dialog: 'widgetbootstrapAlert',

            template: '<div class="alert"><div class="alert-text">Some Text</span></div>',
        ...
        if (typeof editor.config.contentsCss == 'object') {
            ...
            editor.config.contentsCss.push(CKEDITOR.getUrl(this.path + '../../../../lib/bootstrap-3.3.2/css/bootstrap.min.css'));
        }

        else {
            //editor.config.contentsCss = [editor.config.contentsCss, CKEDITOR.getUrl(this.path + 'contents.css')];
            editor.config.contentsCss = [editor.config.contentsCss, CKEDITOR.getUrl(this.path + '../../../../lib/bootstrap-3.3.2/css/bootstrap.min.css')];
        }
