...
$lang['recovery_send_email_btn'] = 'Enviar e-mail de redefinição';
$lang['recovery_return_btn'] = 'Voltar';
$lang['recovery_message_success'] = 'Caso esse e-mail esteja vinculado ao seu cadastro você receberá um e-mail com os dados para redefinição de senha, caso não receba verifique o e-mail na caixa de spam ou na lixeira.';

/* SEND EMAIL */
$lang['recovery_email_title'] = 'Redefinição de senha';
$lang['recovery_email_message'] = 'Você solicitou a redefinição de senha? Se sim clique nesse <a href="%s">link</a> para redefinir a senha, caso não tenha solicitado, ignore esse e-mail.';
