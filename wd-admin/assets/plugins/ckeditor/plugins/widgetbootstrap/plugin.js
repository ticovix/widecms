...
CKEDITOR.plugins.add( 'widgetbootstrap', {
    ...
    init: function( editor ) {
        ...
        editor.widgets.add( 'widgetbootstrapBottomCol', {
            ...
            template:
                '<div class="row two-col-bottom">' +
                    '<div class="col-md-12 col-1"><img src="http://placehold.it/300x100&text=Image" class="img-responsive thumbnail"/>' +
        ...
        editor.widgets.add( 'gallery', {
            ...
            template:
                '<div><div class="row">' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail"/></p></div>' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail"/></p></div>' +
                    '<div class="col-md-4 col-sidebar"><p><img src="http://placehold.it/300x250&text=Image" class="img-responsive thumbnail"/></p></div>' +
                '</div>'+
                '<div class="row">' +
        ...
        editor.widgets.add( 'widgetbootstrapTwoCol', {
            ...
            template:
                '<div class="row two-col">' +
                    '<div class="col-md-6 col-1"><p><img src="http://placehold.it/500x280&text=Image" class="img-responsive thumbnail"/></p><p>Content</p></div>' +
                    '<div class="col-md-6 col-2"><p><img src="http://placehold.it/500x280&text=Image" class="img-responsive thumbnail"/></p><p>Content</p></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapThreeCol', {
            ...
            template:
                '<div class="row three-col">' +
                    '<div class="col-md-4 col-1"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                    '<div class="col-md-4 col-2"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                    '<div class="col-md-4 col-3"><div class="thumbnail"><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/> <h3>Thumbnail label</h3> <p>Text below</p></div></div>' +
                '</div>',
        ...
        if (typeof editor.config.contentsCss == 'object') {
            ...
            //editor.config.contentsCss.push(CKEDITOR.getUrl(this.path + '../../../../lib/bootstrap/css/bootstrap.css'));
        }
